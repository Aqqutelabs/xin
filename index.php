...
<section class="section faq-section" id="faq"><div class="wrap faq-layout"><div><p class="eyebrow">GOOD QUESTIONS</p><h2>A few things you<br>might be wondering.</h2><p>Getting to know your new digital home.</p><a class="text-link" href="pricing.php">Explore pricing <?= home_icon('arrow') ?></a></div><div class="faq-list"><?php foreach ($faqs as $faq): ?><details><summary><?= e($faq[0]) ?><span aria-hidden="true">+</span></summary><p><?= e($faq[1]) ?></p></details><?php endforeach; ?></div></div></section>
...
<footer class="site-footer"><div class="wrap footer-grid"><div><a class="xinng-brand" href="index.php" aria-label="Xinng home"><img class="xinng-brand__image" src="assets/images/logo.svg" alt="Xinng" width="1736" height="906" loading="lazy"></a><h3>Xinng is home.</h3><p>For the different sides of<br>you and your business.</p></div><div><h3>Products</h3><a href="#pages">Xinng Pages</a><a href="#qr">Xinng QR</a><a href="pricing.php">Pricing</a></div><div><h3>Tools</h3><a href="tools/teleprompter/" data-track="teleprompter">Teleprompter</a></div><div><h3>Resources</h3><a href="#learn">Learn</a><a href="#faq">Questions & answers</a><a href="<?= $pageAction ?>">Get started</a></div></div><div class="wrap footer-bottom"><span>© <?= date('Y') ?> Xinng. A home for your different sides.</span><a href="#main">Back to top ↑</a></div></footer>
</body></html>
